...
<body class="">
	...
	<div class="pc-mob-header pc-header">
		<div class="pcm-logo">
			<h5 style="color:white;font-weight:bold;"><?= $authorName; ?></h5>
		</div>
		...
		<div class="navbar-wrapper">
			...
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item"><a href="index.php" class="pc-link "><span class="pc-micon"><i data-feather="home"></i></span><span class="pc-mtext">Dashboard</span></a></li>
					<li class="pc-item"><a href="obat_list.php" class="pc-link "><span class="pc-micon"><i data-feather="activity"></i></span><span class="pc-mtext">Obat</span></a></li>
					<li class="pc-item"><a href="dokter_list.php" class="pc-link "><span class="pc-micon"><i data-feather="home"></i></span><span class="pc-mtext">Dokter</span></a></li>
					<li class="pc-item"><a href="pasien_list.php" class="pc-link "><span class="pc-micon"><i data-feather="home"></i></span><span class="pc-mtext">Pasien</span></a></li>
				</ul>
			</div>
		</div>
	</nav>
					...
					<li class="dropdown pc-h-item">
						<a class="pc-head-link dropdown-toggle arrow-none mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
							...
							<span>
								...
								<span class="user-desc">190511121</span>
							</span>
						</a>
